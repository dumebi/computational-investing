...
startDate = [2011,1,1]
endDate = [2011,12,31]
simulate(startDate,endDate,['AAPL', 'GOOG', 'IBM', 'MSFT'], [0.4, 0.4, 0.0, 0.2], True);
optimize(startDate,endDate,['AAPL', 'GOOG', 'IBM', 'MSFT'], False)

print "------------------ 2 --------------------"

startDate = [2010,1,1]
endDate = [2010,12,31]
simulate(startDate,endDate,['BRCM', 'ADBE', 'AMD', 'ADI'], [0.4, 0.4, 0.0, 0.2], True);
optimize(startDate,endDate,['BRCM', 'ADBE', 'AMD', 'ADI'], False)

print "---------------- 3 ----------------------"
startDate = [2011,1,1]
endDate = [2011,12,31]
simulate(startDate,endDate,['BRCM', 'TXN', 'AMD', 'ADI'], [0.4, 0.4, 0.0, 0.2], True);
optimize(startDate,endDate,['BRCM', 'TXN', 'AMD', 'ADI'], False)

print "-------------- 4 ------------------------"
startDate = [2010,1,1]
endDate = [2010,12,31]
simulate(startDate,endDate,['BRCM', 'TXN', 'IBM', 'HNZ'], [0.4, 0.4, 0.0, 0.2], True);
optimize(startDate,endDate,['BRCM', 'TXN', 'IBM', 'HNZ'], False)

print "-------------- 5 ------------------------"
startDate = [2010,1,1]
endDate = [2010,12,31]
simulate(startDate,endDate,['C', 'GS', 'IBM', 'HNZ'], [0.4, 0.4, 0.0, 0.2], True);
optimize(startDate,endDate,['C', 'GS', 'IBM', 'HNZ'], False)
